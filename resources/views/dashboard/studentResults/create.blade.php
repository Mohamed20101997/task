...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile mb4">
            <form method="POST" action="{{ route('student_result.store') }}" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="seating_number" class="form-control" value="{{ old('seating_number') }}">
