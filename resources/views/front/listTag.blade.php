            ...
            <div class="col-sm-12 col-lg-8">
                <div class="wrap_lists_category">
                   @foreach($articles as $article)
                        ...
                        <div class="wrpa_info"><a class="categore" href="{{route('article.blog',$article->category->id)}}">{{$article->category->name}}</a>
                            <h2><a class="a_hover_none" href="{{route('article.list',$article->id)}}">{{$article->name}}</a></h2>
